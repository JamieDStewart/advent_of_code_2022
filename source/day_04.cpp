...
// Gist:  Elves need to clean up, they have been assigned overlapping sections to clean
//		  Part 1 - Find areas that completely overlap
//		  Part 2 - find areas that partially overlap
// Input data: assigned cleaning areas "x-y,x-y"
//\==============================================================================
#include "days.h"
...
void aoc::day_04()
{
	...
	file_input.open( "./data/day_04_input.txt" );
